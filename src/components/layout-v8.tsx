...
export const LayoutV8 = () => {
  ...
  return (
    <div className="h-screen bg-background flex flex-col">
      {/* Top bar */}
      <div className="bg-accent/10 backdrop-blur-xl border-b border-accent h-14 md:h-10 flex items-center px-4 justify-between">
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={cn(
            'bg-accent/5 border-r border-accent flex flex-col transition-all duration-300 ease-in-out z-20',
            isMobile ? (isSidebarExpanded ? 'fixed inset-y-0 left-0 w-64' : 'hidden') : (isSidebarExpanded ? 'w-64' : 'w-16'),
          )}
        ...
        <div className="flex-1 overflow-auto bg-background p-6">
          {/* Content area - You can add your main dashboard content here */}
            <h1 className="text-2xl font-bold mb-4">Financial Dashboard</h1>
            <p className="text-muted-foreground">Welcome to your financial overview. Add your main content here.</p>
            <Outlet />
        </div>
      </div>
