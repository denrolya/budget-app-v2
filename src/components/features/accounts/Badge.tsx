...
export const AccountBadge = ({ account, size = 'md', className, tooltip = true }: AccountBadgeProps) => {
  const { type, color, displayName } = account;
  ...
  const truncatedText = truncateText(displayName, charLimitMap[size]);
