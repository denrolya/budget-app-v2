...
import { Euro, DollarSign, Bitcoin } from "lucide-react"
...
export function CurrencySelector() {
  ...
  return (
    ...
    >
      <SelectTrigger className="w-[78px] text-xs border-none bg-transparent hover:bg-transparent focus:ring-0 p-0 h-auto hover:text-accent-foreground transition-colors">
        <SelectValue>
