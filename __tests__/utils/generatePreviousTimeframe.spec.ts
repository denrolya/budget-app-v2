...
describe('generatePreviousTimeframe', () => {
  it('should throw an error if startDate is invalid', () => {
    ...
    expect(() => generatePreviousTimeframe(invalidStart, validEnd, 'day')).toThrow(
  ...
  it('should throw an error if endDate is invalid', () => {
    ...
    expect(() => generatePreviousTimeframe(validStart, invalidEnd, 'day')).toThrow(
  ...
  it('should throw an error if unit is invalid', () => {
    ...
    expect(() =>
      generatePreviousTimeframe(start, end, 'invalidUnit' as any),
    ).toThrow('Invalid unit provided. Allowed units are: day, week, month, year');
  });
  ...
  it('should throw an error if startDate is after endDate', () => {
    ...
    expect(() => generatePreviousTimeframe(start, end, 'day')).toThrow(
  ...
  it('should throw an error if the date range does not span at least one unit', () => {
    ...
    expect(() => generatePreviousTimeframe(start, end, 'month')).toThrow(
      'The date range must span at least one unit.',
    );
  });
